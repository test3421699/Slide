            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                >
                  ...
                  <div className="relative w-full aspect-[16/10] md:aspect-[16/9.5] flex items-center justify-center overflow-hidden bg-slate-900/30 rounded-[2.5rem] border border-white/5">
                    {/* Background Plate Stack style decor */}
                    <div className="absolute w-[92%] h-[85%] bg-white/5 rounded-[2rem] translate-y-4 scale-95 border border-white/5 pointer-events-none transition-all duration-300" />
                    ...
                    <div className="w-full h-full relative overflow-hidden rounded-[2.5rem]">
                      <AnimatePresence initial={false} custom={direction} mode="wait">
                        ...
                        <motion.div 
                          ...
                          className="absolute inset-0 p-8 md:p-11 shadow-2xl flex flex-col justify-between transition-all"
                          style={{ 
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between relative z-10 w-full no-print">
                            ...
                            <span className={`text-[10px] py-1 px-2.5 rounded-full font-medium border shadow-sm backdrop-blur-md uppercase font-mono ${
                              presentation.slides[currentIndex].isDark 
                          ...
                          <div className="my-auto py-2 relative z-10 flex flex-col justify-center">
                            <h2 className={`text-2xl sm:text-3xl md:text-4.5xl font-extrabold tracking-tight leading-tight mb-5 ${themeAccent.titleFont}`}>
                            ...
                            <div className="space-y-3.5 md:space-y-4">
                              {presentation.slides[currentIndex].bulletPoints.map((bullet, idx) => (
                                <div key={idx} className="flex items-start gap-3">
                                  <div className={`w-4 h-4 md:w-5 md:h-5 rounded-full flex items-center justify-center shrink-0 mt-1 transition-all ${
                                    presentation.slides[currentIndex].isDark 
                                  ...
                                  <p className={`text-sm sm:text-base md:text-[17px] leading-relaxed opacity-90 ${themeAccent.bodyFont}`}>
                                    {bullet}
                                  </p>
                                </div>
                              ))}
                          ...
                          <div className={`flex items-center justify-between text-[10px] font-medium border-t pt-3 relative z-10 ${
                            presentation.slides[currentIndex].isDark 
                              ? "border-white/10 text-white/50" 
                              : "border-black/10 text-slate-700"
                          }`}>
                            <span className="truncate max-w-[220px] font-medium tracking-tight">
                              {presentation.presentationTitle}
                            </span>
